...
class DecoderRNN(BaseRNN):
    ...
    def __init__(self, vocab_size, max_len, hidden_size, input_size,
                 sos_id, eos_id,
    ...
    def forward_step(self, input_var, hidden, encoder_outputs, function):
        ...
        # output = self.relu(self.bn(output.contiguous().view(-1, self.hidden_size)))
        # predicted_softmax = self.out(output).view(batch_size, output_size, -1)
