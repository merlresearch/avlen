...
DEFAULT_MASTER_ADDR = "169.235.18.95"#"127.0.0.1"
...
def init_distrib_slurm(
    ...
    # print('local_rank, world_rank, world_size', local_rank, world_rank, world_size)
    # print('master_addr, master_port', master_addr, master_port)
