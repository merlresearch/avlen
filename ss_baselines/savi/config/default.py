...
_C.NUM_UPDATES_DIALOG = 30000
_C.LOG_INTERVAL = 10
_C.LOG_FILE = "train.log"
_C.CHECKPOINT_INTERVAL = 50000
_C.CHECKPOINT_INTERVAL_DIALOG = 1000
_C.USE_VECENV = True
...
_C.ORACLE_WHEN_QUERIED= False
_C.REPLAY_STORE = False
_C.SOUND_TYPE = 'unheard'  # just for logging in test case
# -----------------------------------------------------------------------------
# EVAL CONFIG
# -----------------------------------------------------------------------------
_C.EVAL = CN()
...
# -------------------
# sudipta
_C.RL.QUERY_REWARD = -1.0
_C.RL.CONSECUTIVE_REWARD = -.5
_C.RL.QUERY_REWARD_DISTANCE = -1.0
_C.RL.WITH_QUERY_CONSTRAINT = True
_C.RL.NUM_TOTAL_QUERY = 5
_C.RL.SOFT_QUERY_REWARD = False
_C.RL.SOFT_QUERY_REWARD_MAX = -0.1
_C.RL.DISTANCE_DISTRIBUTION_TYPE='gaussian'

_C.RL.WITH_DISTANCE_CONSTRAINT = False
_C.RL.MEAN = 0.0
_C.RL.SD = 0.5
_C.RL.ALPHA = 2.0
_C.RL.BETA = 2.0
...
# --------
_C.RL.PPO.use_state_memory = False
...
# ------ sudipta
_C.RL.DDPPO.master_port = None




# EXTRA CONFIG FOR DIALOG
_C.DIALOG_TRAINING = False
_C.DIALOG_TRAINING_WITHOUT_DIALOG = False
_C.NUM_DIALOG_STEPS = 5

_C.QUERY_COUNT_EMB_SIZE = 32
_C.AGENT_STEP_EMB_SIZE = 128
...
'''
# -----------------------------------------------------------------------------
# ACTION & SIMULATOR for QUERY (sudipta)
# -----------------------------------------------------------------------------
_TC.TASK.ACTIONS.QUERY = CN()
_TC.TASK.ACTIONS.QUERY.TYPE = "QueryAction"
_TC.SIMULATOR.QUERY_STEP = 2.0

# -----------------------------------------------------------------------------
# OTHER (sudipta)
# -----------------------------------------------------------------------------
_TC.TASK.POSSIBLE_ACTIONS = ['STOP', 'MOVE_FORWARD', 'TURN_LEFT', 'TURN_RIGHT', 'QUERY']
'''
    ...
    if run_type == 'train':
        ...
        if not config.DIALOG_TRAINING:
            ...
            if config.EVAL.SPLIT == 'val':
                config.TEST_EPISODE_COUNT = 7051
            elif config.EVAL.SPLIT == 'train':
                config.TEST_EPISODE_COUNT = 77516
        config.freeze()
