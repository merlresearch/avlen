...
class SemanticAudioGoalNavEpisode(NavigationEpisode):
    ...
    # dialog pretraining
    dialog_node: str = attr.ib(default=None)
    sub_instr: str = attr.ib(default=None)
    # direction
    direction: list =attr.ib(default=None)
    # rotation_angle
    rotation_angle: int =attr.ib(default=None)
...
def merge_sim_episode_config(
    ...
    if (
        ...
        # edit (change agent_cfg.SOUND_ID based on heard or unhead sound)
        # agent_cfg.SOUND_ID = 'test_heard/'+ episode.sound_id.split('/')[-1]
