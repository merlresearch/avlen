...
# if want to generate rgb of 224,224 change config
# for 128*128 use default config
# python scripts/cache_observations.py --config-path ss_baselines/av_nav/config/audionav/mp3d/train_telephone/pointgoal_rgb_question.yaml --obs-dir data1/scene_observations_224/  (if 224*224)
...
def main(dataset):
    ...
    parser.add_argument(
        "--obs-dir",
        type=str,
        default='data/scene_observations/'
    )
    parser.add_argument(
        "opts",
        default=None,
    ...
    num_obs = 0
    scene_obs_dir = args.obs_dir + dataset
